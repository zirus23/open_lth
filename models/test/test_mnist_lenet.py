...
class TestMnistLenet(test_case.TestCase):
    ...
    def test_valid_names(self):
        ...
        self.assertTrue(
            mnist_lenet.Model.is_valid_model_name("mnist_lenet_300_100_5000")
        )

    def test_lenet300_100(self):
        model = mnist_lenet.Model.get_model_from_name(
            "mnist_lenet_300_100", initializers.kaiming_normal
        )
        self.assertEqual(self.count_parameters(model), 266610)

    def test_lenet500_500_500(self):
        model = mnist_lenet.Model.get_model_from_name(
            "mnist_lenet_500_500_500", initializers.kaiming_normal
        )
