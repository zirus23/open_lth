...
class TestMetricLogger(test_case.TestCase):
    ...
    def test_sorting(self):
        ...
        self.assertEqual(
            logger.get_data("train_accuracy"),
    ...
    def test_create_from_string(self):
        ...
        self.assertEqual(
            logger.get_data("train_accuracy"), logger2.get_data("train_accuracy")
        )
        self.assertEqual(
            logger.get_data("test_accuracy"), logger2.get_data("test_accuracy")
        )
